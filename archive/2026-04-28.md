...
**Last updated:** 2026-04-28 18:18:29 +08
...
- Diffusion / 生成式AI 今日有 6 篇去重后的候选论文。

### 研究方法

- 当前为规则降级模式，接入模型后会归纳主流研究方法。

### 研究结果

- 当前为规则降级模式，接入模型后会总结实验结果和趋势信号。
